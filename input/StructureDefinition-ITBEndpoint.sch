...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Endpoint">
      ...
      <sch:assert test="count(f:extension[@url = 'http://portal.wof.purified.link/fhir/StructureDefinition/extSourceSystemUserId']) &lt;= 1">extension with URL = 'http://portal.wof.purified.link/fhir/StructureDefinition/extSourceSystemUserId': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
